...
public class HTMLUtility {
     ...
     */
        ...
        StringBuffer sb = new StringBuffer
        		("<select style='width: 160px;  height: 23px;' class='form-control' name='" + name + "'>");
     ...
     */
        ...
        StringBuffer sb = new StringBuffer("<select style='width: 160px;  height: 23px;' class='form-control' name='" + name + "'>");
